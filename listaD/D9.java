...
public class D9 {
	...
	public static void main(String[] args) {
		...
		if (codigo == 3) {
			...
			novo_salario = salario + reajuste;
			System.out.println("O cargo do funcionario é ANALISTA, O novo salario do funcionario é R$"+ novo_salario +", O antigo salario do funcionario era R$"+ salario+ ", O reajuste teve um valor de R$"+ reajuste);
			}
	}		
}
